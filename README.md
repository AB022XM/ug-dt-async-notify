...
To build the final jar and optimize the asyncNotify application for production, run:
...
Then navigate to [http://localhost:9070](http://localhost:9070) in your browser.
